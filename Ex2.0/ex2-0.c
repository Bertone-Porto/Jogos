...
int main (int argc, char* args[])
{
    ...
    /* EXECUÇÃO */
	bool rodando=true, selecionado=false, cancel=false, arrasta=false, clicado=false, iniciado=false, escape=false, arrastado=false, solto=false;
